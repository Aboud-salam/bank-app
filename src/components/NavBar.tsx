  ...
  return (
    <div className="flex justify-between items-center py-6 relative z-[1]">
      ...
      <div className="sm:hidden flex flex-1 items-center justify-end">
        ...
        <div
          className={`${
            toggleNav ? "opacity-100 top-20" : "opacity-0 top-40"
          } transition-all ease-linear delay-0 flex bg-black-gradient p-6 mx-4 my-2 rounded-xl absolute right-0 top-20 min-w-[140px] z-[1]`}
        >
